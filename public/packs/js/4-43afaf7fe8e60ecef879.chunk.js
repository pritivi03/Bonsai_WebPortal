...
var checkFileSizeLimit = function checkFileSizeLimit(file, maximumUploadLimit) {
  ...
  var fileSize = file === null || file === void 0 ? void 0 : (_file$file = file.file) === null || _file$file === void 0 ? void 0 : _file$file.size;
...
/* harmony import */ var _HTMLSanitizer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./HTMLSanitizer */ "./app/javascript/shared/helpers/HTMLSanitizer.js");
...
var MessageFormatter = /*#__PURE__*/function () {
  function MessageFormatter(message) {
    ...
    this.message = dompurify__WEBPACK_IMPORTED_MODULE_8___default.a.sanitize(Object(_HTMLSanitizer__WEBPACK_IMPORTED_MODULE_9__["escapeHtml"])(message || ''));
    this.isATweet = isATweet;
    this.marked = marked__WEBPACK_IMPORTED_MODULE_7___default.a;
    var renderer = {
  ...
  _createClass(MessageFormatter, [{
    ...
    value: function formatMessage() {
      if (this.isATweet) {
        ...
        var markedDownOutput = marked__WEBPACK_IMPORTED_MODULE_7___default()(withHash);
        return markedDownOutput;
      }

      return marked__WEBPACK_IMPORTED_MODULE_7___default()(this.message, {
        breaks: true,
        gfm: true
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  methods: {
    formatMessage: function formatMessage(message, isATweet) {
...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
...
/* harmony import */ var shared_constants_messages__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! shared/constants/messages */ "./app/javascript/shared/constants/messages.js");
/* harmony import */ var shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! shared/components/FluentIcon/Index.vue */ "./app/javascript/shared/components/FluentIcon/Index.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    FluentIcon: shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_16__["default"]
  },
  props: {
  ...
  data: function data() {
    return {
      email: '',
      ratings: shared_constants_messages__WEBPACK_IMPORTED_MODULE_15__["CSAT_RATINGS"],
      selectedRating: null,
      isUpdating: false,
      feedback: ''
    };
...
/* harmony import */ var widget_components_UserMessage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! widget/components/UserMessage */ "./app/javascript/widget/components/UserMessage.vue");
/* harmony import */ var widget_components_AgentMessageBubble__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! widget/components/AgentMessageBubble */ "./app/javascript/widget/components/AgentMessageBubble.vue");
/* harmony import */ var dashboard_mixins_time__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! dashboard/mixins/time */ "./app/javascript/dashboard/mixins/time.js");
/* harmony import */ var widget_components_ImageBubble__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! widget/components/ImageBubble */ "./app/javascript/widget/components/ImageBubble.vue");
/* harmony import */ var widget_components_FileBubble__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! widget/components/FileBubble */ "./app/javascript/widget/components/FileBubble.vue");
/* harmony import */ var dashboard_components_widgets_Thumbnail__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! dashboard/components/widgets/Thumbnail */ "./app/javascript/dashboard/components/widgets/Thumbnail.vue");
/* harmony import */ var widget_helpers_constants__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! widget/helpers/constants */ "./app/javascript/widget/helpers/constants.js");
/* harmony import */ var _mixins_configMixin__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../mixins/configMixin */ "./app/javascript/widget/mixins/configMixin.js");
/* harmony import */ var _mixins_messageMixin__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../mixins/messageMixin */ "./app/javascript/widget/mixins/messageMixin.js");
/* harmony import */ var shared_helpers_MessageTypeHelper__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! shared/helpers/MessageTypeHelper */ "./app/javascript/shared/helpers/MessageTypeHelper.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'AgentMessage',
  components: {
    AgentMessageBubble: widget_components_AgentMessageBubble__WEBPACK_IMPORTED_MODULE_14__["default"],
    ImageBubble: widget_components_ImageBubble__WEBPACK_IMPORTED_MODULE_16__["default"],
    Thumbnail: dashboard_components_widgets_Thumbnail__WEBPACK_IMPORTED_MODULE_18__["default"],
    UserMessage: widget_components_UserMessage__WEBPACK_IMPORTED_MODULE_13__["default"],
    FileBubble: widget_components_FileBubble__WEBPACK_IMPORTED_MODULE_17__["default"]
  },
  mixins: [dashboard_mixins_time__WEBPACK_IMPORTED_MODULE_15__["default"], _mixins_configMixin__WEBPACK_IMPORTED_MODULE_20__["default"], _mixins_messageMixin__WEBPACK_IMPORTED_MODULE_21__["default"]],
  props: {
    message: {
      type: Object,
      "default": function _default() {}
  ...
  computed: {
    ...
    agentName: function agentName() {
      if (this.message.message_type === widget_helpers_constants__WEBPACK_IMPORTED_MODULE_19__["MESSAGE_TYPE"].TEMPLATE) {
        return 'Bot';
      }
    ...
    isASubmittedForm: function isASubmittedForm() {
      return Object(shared_helpers_MessageTypeHelper__WEBPACK_IMPORTED_MODULE_22__["isASubmittedFormMessage"])(this.message);
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [shared_mixins_messageFormatterMixin__WEBPACK_IMPORTED_MODULE_3__["default"]],
  props: {
    message: {
      type: String,
      "default": null
...
/* harmony import */ var vue_upload_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-upload-component */ "./node_modules/vue-upload-component/dist/vue-upload-component.js");
/* harmony import */ var vue_upload_component__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(vue_upload_component__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var shared_components_Spinner_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! shared/components/Spinner.vue */ "./app/javascript/shared/components/Spinner.vue");
/* harmony import */ var shared_helpers_FileHelper__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! shared/helpers/FileHelper */ "./app/javascript/shared/helpers/FileHelper.js");
...
/* harmony import */ var shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! shared/constants/busEvents */ "./app/javascript/shared/constants/busEvents.js");
/* harmony import */ var shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! shared/components/FluentIcon/Index.vue */ "./app/javascript/shared/components/FluentIcon/Index.vue");
/* harmony import */ var activestorage__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! activestorage */ "./node_modules/activestorage/app/assets/javascripts/activestorage.js");
/* harmony import */ var activestorage__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(activestorage__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    FluentIcon: shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    FileUpload: vue_upload_component__WEBPACK_IMPORTED_MODULE_10___default.a,
    Spinner: shared_components_Spinner_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  props: {
    onAttach: {
      type: Function,
  ...
  computed: {
    fileUploadSizeLimit: function fileUploadSizeLimit() {
      return shared_constants_messages__WEBPACK_IMPORTED_MODULE_13__["MAXIMUM_FILE_UPLOAD_SIZE"];
    },
    allowedFileTypes: function allowedFileTypes() {
      return shared_constants_messages__WEBPACK_IMPORTED_MODULE_13__["ALLOWED_FILE_TYPES"];
    }
  },
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                try {
                  if (Object(shared_helpers_FileHelper__WEBPACK_IMPORTED_MODULE_12__["checkFileSizeLimit"])(file, shared_constants_messages__WEBPACK_IMPORTED_MODULE_13__["MAXIMUM_FILE_UPLOAD_SIZE"])) {
                    upload = new activestorage__WEBPACK_IMPORTED_MODULE_16__["DirectUpload"](file.file, '/rails/active_storage/direct_uploads', null, file.file.name);
                    upload.create(function (error, blob) {
                      if (error) {
                        window.bus.$emit(shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_14__["BUS_EVENTS"].SHOW_ALERT, {
                          message: error
                        });
                      } else {
                        _this.onAttach({
                    ...
                    window.bus.$emit(shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_14__["BUS_EVENTS"].SHOW_ALERT, {
                      message: _this.$t('FILE_SIZE_LIMIT', {
                        MAXIMUM_FILE_UPLOAD_SIZE: _this.fileUploadSizeLimit
                      })
                    });
                  }
                } catch (error) {// Error
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 8;
                return _this2.onAttach({
                  fileType: _this2.getFileType(file.type),
                  file: file.file,
                  thumbUrl: thumbUrl
                });
...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
...
/* harmony import */ var _chatwoot_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @chatwoot/utils */ "./node_modules/@chatwoot/utils/dist/utils.esm.js");
/* harmony import */ var shared_components_Button__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! shared/components/Button */ "./app/javascript/shared/components/Button.vue");
/* harmony import */ var widget_components_ChatInputWrap_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! widget/components/ChatInputWrap.vue */ "./app/javascript/widget/components/ChatInputWrap.vue");
/* harmony import */ var shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! shared/constants/busEvents */ "./app/javascript/shared/constants/busEvents.js");
/* harmony import */ var widget_api_conversation__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! widget/api/conversation */ "./app/javascript/widget/api/conversation.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ChatInputWrap: widget_components_ChatInputWrap_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    CustomButton: shared_components_Button__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  props: {
    msg: {
      type: String,
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_12__["mapGetters"])({
    ...
    textColor: function textColor() {
      return Object(_chatwoot_utils__WEBPACK_IMPORTED_MODULE_13__["getContrastingTextColor"])(this.widgetColor);
    },
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_12__["mapActions"])('conversation', ['sendMessage', 'sendAttachment', 'clearConversations'])), Object(vuex__WEBPACK_IMPORTED_MODULE_12__["mapActions"])('conversationAttributes', ['getAttributes', 'clearConversationAttributes'])), {}, {
    handleSendMessage: function handleSendMessage(content) {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var conversationSize;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                conversationSize = _this.getConversationSize;
                _context.next = 3;
    ...
    startNewConversation: function startNewConversation() {
      ...
      window.bus.$emit(shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_16__["BUS_EVENTS"].START_NEW_CONVERSATION);
    },
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return Object(widget_api_conversation__WEBPACK_IMPORTED_MODULE_17__["sendEmailTranscript"])({
                  email: email
                });

              case 5:
                window.bus.$emit(shared_constants_busEvents__WEBPACK_IMPORTED_MODULE_16__["BUS_EVENTS"].SHOW_ALERT, {
...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(vuex__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var vue_clickaway__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! vue-clickaway */ "./node_modules/vue-clickaway/dist/vue-clickaway.common.js");
/* harmony import */ var vue_clickaway__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(vue_clickaway__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var widget_components_ChatAttachment_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! widget/components/ChatAttachment.vue */ "./app/javascript/widget/components/ChatAttachment.vue");
/* harmony import */ var widget_components_ChatSendButton_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! widget/components/ChatSendButton.vue */ "./app/javascript/widget/components/ChatSendButton.vue");
/* harmony import */ var _mixins_configMixin__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../mixins/configMixin */ "./app/javascript/widget/mixins/configMixin.js");
/* harmony import */ var shared_components_emoji_EmojiInput__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! shared/components/emoji/EmojiInput */ "./app/javascript/shared/components/emoji/EmojiInput.vue");
/* harmony import */ var shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! shared/components/FluentIcon/Index.vue */ "./app/javascript/shared/components/FluentIcon/Index.vue");
/* harmony import */ var shared_components_ResizableTextArea__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! shared/components/ResizableTextArea */ "./app/javascript/shared/components/ResizableTextArea.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'ChatInputWrap',
  components: {
    ChatAttachmentButton: widget_components_ChatAttachment_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
    ChatSendButton: widget_components_ChatSendButton_vue__WEBPACK_IMPORTED_MODULE_14__["default"],
    EmojiInput: shared_components_emoji_EmojiInput__WEBPACK_IMPORTED_MODULE_16__["default"],
    FluentIcon: shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_17__["default"],
    ResizableTextArea: shared_components_ResizableTextArea__WEBPACK_IMPORTED_MODULE_18__["default"]
  },
  mixins: [vue_clickaway__WEBPACK_IMPORTED_MODULE_12__["mixin"], _mixins_configMixin__WEBPACK_IMPORTED_MODULE_15__["default"]],
  props: {
    onSendMessage: {
      type: Function,
      "default": function _default() {}
...
/* harmony import */ var core_js_modules_es_object_define_properties_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core-js/modules/es.object.define-properties.js */ "./node_modules/core-js/modules/es.object.define-properties.js");
/* harmony import */ var core_js_modules_es_object_define_properties_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_properties_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var widget_components_ChatMessage_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! widget/components/ChatMessage.vue */ "./app/javascript/widget/components/ChatMessage.vue");
/* harmony import */ var widget_components_AgentTypingBubble_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! widget/components/AgentTypingBubble.vue */ "./app/javascript/widget/components/AgentTypingBubble.vue");
/* harmony import */ var shared_components_DateSeparator_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! shared/components/DateSeparator.vue */ "./app/javascript/shared/components/DateSeparator.vue");
/* harmony import */ var shared_components_Spinner_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! shared/components/Spinner.vue */ "./app/javascript/shared/components/Spinner.vue");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(vuex__WEBPACK_IMPORTED_MODULE_13__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ChatMessage: widget_components_ChatMessage_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    AgentTypingBubble: widget_components_AgentTypingBubble_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    DateSeparator: shared_components_DateSeparator_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
    Spinner: shared_components_Spinner_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
  },
  props: {
    groupedMessages: {
      type: Array,
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_13__["mapActions"])('conversation', ['fetchOldConversations'])), {}, {
...
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! regenerator-runtime/runtime.js */ "./node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var widget_components_UserMessageBubble__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! widget/components/UserMessageBubble */ "./app/javascript/widget/components/UserMessageBubble.vue");
/* harmony import */ var widget_components_ImageBubble__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! widget/components/ImageBubble */ "./app/javascript/widget/components/ImageBubble.vue");
/* harmony import */ var shared_components_FluentIcon_Index__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! shared/components/FluentIcon/Index */ "./app/javascript/shared/components/FluentIcon/Index.vue");
/* harmony import */ var widget_components_FileBubble__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! widget/components/FileBubble */ "./app/javascript/widget/components/FileBubble.vue");
/* harmony import */ var dashboard_mixins_time__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! dashboard/mixins/time */ "./app/javascript/dashboard/mixins/time.js");
/* harmony import */ var _mixins_messageMixin__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../mixins/messageMixin */ "./app/javascript/widget/mixins/messageMixin.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'UserMessage',
  components: {
    UserMessageBubble: widget_components_UserMessageBubble__WEBPACK_IMPORTED_MODULE_12__["default"],
    ImageBubble: widget_components_ImageBubble__WEBPACK_IMPORTED_MODULE_13__["default"],
    FileBubble: widget_components_FileBubble__WEBPACK_IMPORTED_MODULE_15__["default"],
    FluentIcon: shared_components_FluentIcon_Index__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  mixins: [dashboard_mixins_time__WEBPACK_IMPORTED_MODULE_16__["default"], _mixins_messageMixin__WEBPACK_IMPORTED_MODULE_17__["default"]],
  props: {
    message: {
      type: Object,
      "default": function _default() {}
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_18__["mapGetters"])({
    widgetColor: 'appConfig/getWidgetColor'
  })), {}, {
...
/* harmony import */ var shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! shared/components/FluentIcon/Index.vue */ "./app/javascript/shared/components/FluentIcon/Index.vue");
/* harmony import */ var shared_components_Spinner__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! shared/components/Spinner */ "./app/javascript/shared/components/Spinner.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    FluentIcon: shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    Spinner: shared_components_Spinner__WEBPACK_IMPORTED_MODULE_16__["default"]
  },
  props: {
    messageId: {
      type: Number,
  ...
  validations: {
    email: {
      ...
      email: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__["email"]
    }
  },
  methods: {
    onSubmit: function onSubmit() {
...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(vuex__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _components_ChatFooter_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/ChatFooter.vue */ "./app/javascript/widget/components/ChatFooter.vue");
/* harmony import */ var _components_ConversationWrap_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/ConversationWrap.vue */ "./app/javascript/widget/components/ConversationWrap.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ChatFooter: _components_ChatFooter_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    ConversationWrap: _components_ConversationWrap_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_9__["mapGetters"])({
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".option[data-v-44aaf3d2] {\n  border-radius: 5rem;\n  border: 1px solid #1f93ff;\n  float: left;\n  margin: 0.25rem;\n  max-width: 100%;\n}\n.option .option-button[data-v-44aaf3d2] {\n  background: transparent;\n  border-radius: 2rem;\n  border: 0;\n  color: #1f93ff;\n  cursor: pointer;\n  height: auto;\n  line-height: 1.5;\n  min-height: 2.5rem;\n  text-align: left;\n  white-space: normal;\n}\n.option .option-button span[data-v-44aaf3d2] {\n  display: inline-block;\n  vertical-align: middle;\n}\n.option .option-button > .icon[data-v-44aaf3d2] {\n  margin-right: 0.25rem;\n  font-size: 1rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/shared/components/ChatOption.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AA0CA;EACE,mBClBY;EDmBZ,yBAAA;EACA,WAAA;EACA,eC/Bc;EDgCd,eAAA;AAzCF;AA2CE;EACE,uBAAA;EACA,mBC7BU;ED8BV,SAAA;EACA,cChBS;EDiBT,eAAA;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,gBAAA;EACA,mBAAA;AAzCJ;AA2CI;EACE,qBAAA;EACA,sBAAA;AAzCN;AA4CI;EACE,qBCpDU;EDqDV,eC/Da;ADqBnB","file":"ChatOption.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.option {\n  border-radius: $space-jumbo;\n  border: 1px solid $color-woot;\n  float: left;\n  margin: $space-smaller;\n  max-width: 100%;\n\n  .option-button {\n    background: transparent;\n    border-radius: $space-large;\n    border: 0;\n    color: $color-woot;\n    cursor: pointer;\n    height: auto;\n    line-height: 1.5;\n    min-height: $space-two * 2;\n    text-align: left;\n    white-space: normal;\n\n    span {\n      display: inline-block;\n      vertical-align: middle;\n    }\n\n    > .icon {\n      margin-right: $space-smaller;\n      font-size: $font-size-medium;\n    }\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".has-selected .option-button:not(.is-selected) {\n  color: #999a9b;\n  cursor: auto;\n  cursor: initial;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/shared/components/ChatOptions.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/dashboard/assets/scss/_variables.scss"],"names":[],"mappings":"AA8DE;EACE,cClBe;EDmBf,YAAA;EAAA,eAAA;AA7DJ","file":"ChatOptions.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~dashboard/assets/scss/variables.scss';\n.has-selected {\n  .option-button:not(.is-selected) {\n    color: $color-light-gray;\n    cursor: initial;\n  }\n}\n","// Font sizes\n$font-size-nano: 0.8rem;\n$font-size-micro: 1.0rem;\n$font-size-mini: 1.2rem;\n$font-size-small: 1.4rem;\n$font-size-default: 1.6rem;\n$font-size-medium: 1.8rem;\n$font-size-large: 2.2rem;\n$font-size-big: 2.4rem;\n$font-size-bigger: 3.0rem;\n$font-size-mega: 3.4rem;\n$font-size-giga: 4.0rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.2rem;\n$space-smaller: 0.4rem;\n$space-small: 0.8rem;\n$space-one: 1rem;\n$space-slab: 1.2rem;\n$space-normal: 1.6rem;\n$space-two: 2.0rem;\n$space-medium: 2.4rem;\n$space-large: 3.2rem;\n$space-larger: 4.8rem;\n$space-jumbo: 6.4rem;\n$space-mega: 10.0rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n//Navbar\n$nav-bar-width: 23rem;\n$header-height: 5.6rem;\n\n$woot-logo-padding: $space-large $space-two;\n\n// Colors\n$color-woot: #1f93ff;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n\n$color-border: var(--s-75);\n$color-border-light: var(--s-50);\n$color-border-dark: var(--s-100);\n\n$color-background: var(--s-50);\n$color-background-light: var(--s-25);\n\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-extra-light-blue: #f5f7f9;\n\n$primary-color: $color-woot;\n$secondary-color: #5d7592;\n$success-color: #44ce4b;\n$warning-color: #ffc532;\n$alert-color: #ff382d;\n\n$masked-bg: rgba(0, 0, 0, .4);\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Thumbnail\n$thumbnail-radius: 4rem;\n\n// chat-header\n$conv-header-height: 4rem;\n\n// Inbox List\n\n$inbox-thumb-size: 4.8rem;\n\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-function: cubic-bezier(0.37, 0, 0.63, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-function !default;\n\n// Ionicons\n$ionicons-font-path: '~ionicons/fonts';\n\n// Transitions\n$transition-ease-in: all 0.250s ease-in;\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".options-message[data-v-545f2791] {\n  max-width: 17rem;\n  padding: 0.5rem 1rem;\n  border-radius: 0.5rem;\n  overflow: hidden;\n}\n.options-message .title[data-v-545f2791] {\n  font-size: 0.875rem;\n  font-weight: 400;\n  margin-top: 0.25rem;\n  margin-bottom: 0.25rem;\n  color: #1f2d3d;\n  line-height: 1.5;\n}\n.options-message .options[data-v-545f2791] {\n  width: 100%;\n}\n.options-message .options > li[data-v-545f2791] {\n  list-style: none;\n  padding: 0;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/shared/components/ChatOptions.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAuEA;EACE,gBAAA;EACA,oBAAA;EACA,qBC1DY;ED2DZ,gBAAA;AAtEF;AAwEE;EACE,mBC1EgB;ED2EhB,gBChDiB;EDiDjB,mBCjEY;EDkEZ,sBClEY;EDmEZ,cCjCY;EDkCZ,gBAAA;AAtEJ;AAyEE;EACE,WAAA;AAvEJ;AAyEI;EACE,gBAAA;EACA,UAAA;AAvEN","file":"ChatOptions.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.options-message {\n  max-width: 17rem;\n  padding: $space-small $space-normal;\n  border-radius: $space-small;\n  overflow: hidden;\n\n  .title {\n    font-size: $font-size-default;\n    font-weight: $font-weight-normal;\n    margin-top: $space-smaller;\n    margin-bottom: $space-smaller;\n    color: $color-heading;\n    line-height: 1.5;\n  }\n\n  .options {\n    width: 100%;\n\n    > li {\n      list-style: none;\n      padding: 0;\n    }\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".customer-satisfcation[data-v-b486baa2] {\n  box-shadow: 0 0.25rem 6px rgba(50, 50, 93, 0.08), 0 1px 3px rgba(0, 0, 0, 0.05);\n  background: #fff;\n  border-bottom-left-radius: 0.25rem;\n  border-radius: 0.5rem;\n  border-top: 0.125rem solid #1f93ff;\n  color: #3c4858;\n  display: inline-block;\n  line-height: 1.5;\n  margin-top: 0.25rem;\n  width: 80%;\n}\n.customer-satisfcation .title[data-v-b486baa2] {\n  font-size: 0.875rem;\n  font-weight: 500;\n  padding: 1.25rem 0.625rem 0;\n  text-align: center;\n}\n.customer-satisfcation .ratings[data-v-b486baa2] {\n  display: flex;\n  justify-content: space-around;\n  padding: 1.25rem 1rem;\n}\n.customer-satisfcation .ratings .emoji-button[data-v-b486baa2] {\n  box-shadow: none;\n  filter: grayscale(100%);\n  font-size: 1.5rem;\n  outline: none;\n}\n.customer-satisfcation .ratings .emoji-button.selected[data-v-b486baa2], .customer-satisfcation .ratings .emoji-button[data-v-b486baa2]:hover, .customer-satisfcation .ratings .emoji-button[data-v-b486baa2]:focus, .customer-satisfcation .ratings .emoji-button[data-v-b486baa2]:active {\n  filter: grayscale(0%);\n  transform: scale(1.32);\n}\n.customer-satisfcation .ratings .emoji-button.disabled[data-v-b486baa2] {\n  cursor: default;\n  opacity: 0.5;\n  pointer-events: none;\n}\n.customer-satisfcation .feedback-form[data-v-b486baa2] {\n  display: flex;\n}\n.customer-satisfcation .feedback-form input[data-v-b486baa2] {\n  border-bottom-right-radius: 0;\n  border-top-right-radius: 0;\n  border-bottom-left-radius: 0.5rem;\n  border: 0;\n  border-top: 1px solid #e0e6ed;\n  padding: 0.625rem;\n  width: 100%;\n}\n.customer-satisfcation .feedback-form .button[data-v-b486baa2] {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  border-bottom-left-radius: 0;\n  border-top-left-radius: 0;\n  border-bottom-right-radius: 0.5rem;\n  font-size: 1.25rem;\n  height: auto;\n  margin-left: -1px;\n}\n.customer-satisfcation .feedback-form .button .spinner[data-v-b486baa2] {\n  display: block;\n  padding: 0;\n  height: auto;\n  width: auto;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/shared/components/CustomerSatisfaction.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_mixins.scss","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AA0IA;EC1HE,+EAAA;ED6HA,gBE9FY;EF+FZ,kCE/Hc;EFgId,qBE/HY;EFgIZ,kCAAA;EACA,cEjGW;EFkGX,qBAAA;EACA,gBAAA;EACA,mBErIc;EFsId,UAAA;AA1IF;AA4IE;EACE,mBEpJgB;EFqJhB,gBEzHiB;EF0HjB,2BAAA;EACA,kBAAA;AA1IJ;AA6IE;EACE,aAAA;EACA,6BAAA;EACA,qBAAA;AA3IJ;AA6II;EACE,gBAAA;EACA,uBAAA;EACA,iBE/JU;EFgKV,aAAA;AA3IN;AA6IM;EAIE,qBAAA;EACA,sBAAA;AA9IR;AAiJM;EACE,eAAA;EACA,YAAA;EACA,oBAAA;AA/IR;AAmJE;EACE,aAAA;AAjJJ;AAmJI;EACE,6BAAA;EACA,0BAAA;EACA,iCE9KQ;EF+KR,SAAA;EACA,6BAAA;EACA,iBEhLM;EFiLN,WAAA;AAjJN;AAoJI;EACE,wBAAA;EAAA,qBAAA;EAAA,gBAAA;EACA,4BAAA;EACA,yBAAA;EACA,kCEzLQ;EF0LR,kBEpMY;EFqMZ,YAAA;EACA,iBAAA;AAlJN;AAoJM;EACE,cAAA;EACA,UAAA;EACA,YAAA;EACA,WAAA;AAlJR","file":"CustomerSatisfaction.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n@import '~widget/assets/scss/mixins.scss';\n\n.customer-satisfcation {\n  @include light-shadow;\n\n  background: $color-white;\n  border-bottom-left-radius: $space-smaller;\n  border-radius: $space-small;\n  border-top: $space-micro solid $color-woot;\n  color: $color-body;\n  display: inline-block;\n  line-height: 1.5;\n  margin-top: $space-smaller;\n  width: 80%;\n\n  .title {\n    font-size: $font-size-default;\n    font-weight: $font-weight-medium;\n    padding: $space-two $space-one 0;\n    text-align: center;\n  }\n\n  .ratings {\n    display: flex;\n    justify-content: space-around;\n    padding: $space-two $space-normal;\n\n    .emoji-button {\n      box-shadow: none;\n      filter: grayscale(100%);\n      font-size: $font-size-big;\n      outline: none;\n\n      &.selected,\n      &:hover,\n      &:focus,\n      &:active {\n        filter: grayscale(0%);\n        transform: scale(1.32);\n      }\n\n      &.disabled {\n        cursor: default;\n        opacity: 0.5;\n        pointer-events: none;\n      }\n    }\n  }\n  .feedback-form {\n    display: flex;\n\n    input {\n      border-bottom-right-radius: 0;\n      border-top-right-radius: 0;\n      border-bottom-left-radius: $space-small;\n      border: 0;\n      border-top: 1px solid $color-border;\n      padding: $space-one;\n      width: 100%;\n    }\n\n    .button {\n      appearance: none;\n      border-bottom-left-radius: 0;\n      border-top-left-radius: 0;\n      border-bottom-right-radius: $space-small;\n      font-size: $font-size-large;\n      height: auto;\n      margin-left: -1px;\n\n      .spinner {\n        display: block;\n        padding: 0;\n        height: auto;\n        width: auto;\n      }\n    }\n  }\n}\n","// scss-lint:disable PseudoElement SpaceBeforeBrace VendorPrefix\n$shadow-color-1: rgba(50, 50, 93, 0.08);\n$shadow-color-2: rgba(0, 0, 0, 0.07);\n$shadow-color-3: rgba(50, 50, 93, .08);\n$shadow-color-4: rgba(0, 0, 0, .05);\n\n$color-shadow-medium: rgba(50, 50, 93, 0.08);\n$color-shadow-light: rgba(50, 50, 93, 0.04);\n$color-shadow-large: rgba(50, 50, 93, 0.25);\n$color-shadow-outline: rgba(66, 153, 225, 0.5);\n\n@mixin normal-shadow {\n  box-shadow: 0 $space-small $space-normal $shadow-color-1, 0 $space-smaller $space-slab $shadow-color-2;\n}\n\n@mixin light-shadow {\n  box-shadow: 0 $space-smaller 6px $shadow-color-3, 0 1px 3px $shadow-color-4;\n}\n\n@mixin placeholder {\n  &::-webkit-input-placeholder {\n    @content\n  }\n\n  &:-moz-placeholder {\n    @content\n  }\n\n  &::-moz-placeholder {\n    @content\n  }\n\n  &:-ms-input-placeholder {\n    @content\n  }\n}\n\n@mixin shadow {\n  box-shadow: 0 1px 10px 2px $color-shadow-medium,\n    0 1px 5px 1px $color-shadow-light;\n}\n\n\n@mixin shadow-medium {\n  box-shadow: 0 4px 24px 4px $color-shadow-medium,\n    0 2px 16px 2px $color-shadow-light;\n}\n\n\n@mixin shadow-large {\n  box-shadow: 0 10px 15px -16px $color-shadow-medium,\n    0 4px 6px -8px $color-shadow-light;\n}\n\n\n@mixin shadow-big {\n  box-shadow: 0 20px 25px -20px $color-shadow-medium,\n    0 10px 10px -10px $color-shadow-light;\n}\n\n\n@mixin shadow-mega {\n  box-shadow: 0 25px 50px -12px $color-shadow-big;\n}\n\n@mixin shadow-inner {\n  box-shadow: inset 0 2px 4px 0 $color-shadow-light;\n}\n\n@mixin shadow-outline {\n  box-shadow: 0 0 0 3px $color-shadow-outline;\n}\n\n@mixin shadow-none {\n  box-shadow: none;\n}\n\n@mixin button-size {\n  min-height: $space-large;\n  min-width: $space-large;\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".date--separator[data-v-50e605fc] {\n  font-size: 0.875rem;\n  color: #3c4858;\n  height: 50px;\n  line-height: 50px;\n  position: relative;\n  text-align: center;\n  width: 100%;\n}\n.date--separator[data-v-50e605fc]::before,\n.date--separator[data-v-50e605fc]::after {\n  background-color: #e0e6ed;\n  content: \"\";\n  height: 1px;\n  position: absolute;\n  top: 24px;\n  width: calc((100% - 120px) / 2);\n}\n.date--separator[data-v-50e605fc]::before {\n  left: 0;\n}\n.date--separator[data-v-50e605fc]::after {\n  right: 0;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/shared/components/DateSeparator.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AA8BA;EACE,mBC3BkB;ED4BlB,cCgBW;EDfX,YAAA;EACA,iBAAA;EACA,kBAAA;EACA,kBAAA;EACA,WAAA;AA7BF;AAgCA;;EAEE,yBCDa;EDEb,WAAA;EACA,WAAA;EACA,kBAAA;EACA,SAAA;EACA,+BAAA;AA7BF;AAgCA;EACE,OAAA;AA7BF;AAgCA;EACE,QAAA;AA7BF","file":"DateSeparator.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables';\n\n.date--separator {\n  font-size: $font-size-default;\n  color: $color-body;\n  height: 50px;\n  line-height: 50px;\n  position: relative;\n  text-align: center;\n  width: 100%;\n}\n\n.date--separator::before,\n.date--separator::after {\n  background-color: $color-border;\n  content: '';\n  height: 1px;\n  position: absolute;\n  top: 24px;\n  width: calc((100% - 120px) / 2);\n}\n\n.date--separator::before {\n  left: 0;\n}\n\n.date--separator::after {\n  right: 0;\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".chat-bubble .message-content[data-v-68d2faf2] pre {\n  background: #c7e3ff;\n  color: #3c4858;\n  overflow: scroll;\n  padding: 0.25rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/AgentMessageBubble.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAsIA;EACE,mBChFoB;EDiFpB,cCxFW;EDyFX,gBAAA;EACA,gBC3Hc;ADVhB","file":"AgentMessageBubble.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.chat-bubble .message-content::v-deep pre {\n  background: $color-primary-light;\n  color: $color-body;\n  overflow: scroll;\n  padding: $space-smaller;\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".agent-message-wrap[data-v-66995298] {\n  position: -webkit-sticky;\n  position: sticky;\n  bottom: 0.25rem;\n}\n.typing-bubble[data-v-66995298] {\n  max-width: 2.4rem;\n  padding: 0.5rem;\n  border-bottom-left-radius: 1.25rem;\n  border-top-left-radius: 0.5rem;\n}\n.typing-bubble img[data-v-66995298] {\n  width: 100%;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/AgentTypingBubble.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAyBA;EACE,wBAAA;EAAA,gBAAA;EACA,eCZc;ADZhB;AA2BA;EACE,iBAAA;EACA,eChBY;EDiBZ,kCCbU;EDcV,8BClBY;ADNd;AA0BE;EACE,WAAA;AAxBJ","file":"AgentTypingBubble.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n.agent-message-wrap {\n  position: sticky;\n  bottom: $space-smaller;\n}\n\n.typing-bubble {\n  max-width: $space-normal * 2.4;\n  padding: $space-small;\n  border-bottom-left-radius: $space-two;\n  border-top-left-radius: $space-small;\n\n  img {\n    width: 100%;\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".branding[data-v-4dca2317] {\n  align-items: center;\n  color: #3c4858;\n  display: flex;\n  font-size: 0.875rem;\n  justify-content: center;\n  padding: 0.625rem;\n  text-align: center;\n  text-decoration: none;\n}\n.branding img[data-v-4dca2317] {\n  margin-right: 0.5rem;\n  max-width: 1.25rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/ChatFooter.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAyHA;EACE,mBAAA;EACA,cC3EW;ED4EX,aAAA;EACA,mBCzHkB;ED0HlB,uBAAA;EACA,iBC9GU;ED+GV,kBAAA;EACA,qBAAA;AAxHF;AA0HE;EACE,oBCpHU;EDqHV,kBCjHQ;ADPZ","file":"ChatFooter.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.branding {\n  align-items: center;\n  color: $color-body;\n  display: flex;\n  font-size: $font-size-default;\n  justify-content: center;\n  padding: $space-one;\n  text-align: center;\n  text-decoration: none;\n\n  img {\n    margin-right: $space-small;\n    max-width: $space-two;\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".chat-message--input[data-v-672614e8] {\n  align-items: center;\n  display: flex;\n  padding: 0 0.5rem 0 0.75rem;\n  border-radius: 7px;\n}\n.chat-message--input.is-focused[data-v-672614e8] {\n  box-shadow: 0 0 0 1px #1f93ff, 0 0 2px 3px #c7e3ff;\n}\n.emoji-dialog[data-v-672614e8] {\n  right: 0.625rem;\n}\n.button-wrap[data-v-672614e8] {\n  display: flex;\n  align-items: center;\n  padding-left: 0.5rem;\n}\n.user-message-input[data-v-672614e8] {\n  border: 0;\n  height: 2rem;\n  min-height: 2rem;\n  max-height: 15rem;\n  resize: none;\n  padding: 0;\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n  margin-top: 0.5rem;\n  margin-bottom: 0.5rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/ChatInputWrap.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AA0KA;EACE,mBAAA;EACA,aAAA;EACA,2BAAA;EACA,kBAAA;AAzKF;AA2KE;EACE,kDAAA;AAzKJ;AA6KA;EACE,eCrKU;ADLZ;AA6KA;EACE,aAAA;EACA,mBAAA;EACA,oBC5KY;ADEd;AA6KA;EACE,SAAA;EACA,YC3KY;ED4KZ,gBC5KY;ED6KZ,iBAAA;EACA,YAAA;EACA,UAAA;EACA,oBCvLc;EDwLd,uBCxLc;EDyLd,kBCxLY;EDyLZ,qBCzLY;ADed","file":"ChatInputWrap.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n@import '~widget/assets/scss/mixins.scss';\n\n.chat-message--input {\n  align-items: center;\n  display: flex;\n  padding: 0 $space-small 0 $space-slab;\n  border-radius: 7px;\n\n  &.is-focused {\n    box-shadow: 0 0 0 1px $color-woot, 0 0 2px 3px $color-primary-light;\n  }\n}\n\n.emoji-dialog {\n  right: $space-one;\n}\n\n.button-wrap {\n  display: flex;\n  align-items: center;\n  padding-left: $space-small;\n}\n\n.user-message-input {\n  border: 0;\n  height: $space-large;\n  min-height: $space-large;\n  max-height: 2.4 * $space-mega;\n  resize: none;\n  padding: 0;\n  padding-top: $space-smaller;\n  padding-bottom: $space-smaller;\n  margin-top: $space-small;\n  margin-bottom: $space-small;\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".message-wrap[data-v-0ed5398a] {\n  display: flex;\n  flex-direction: row;\n  align-items: flex-end;\n  max-width: 90%;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/ChatMessage.vue"],"names":[],"mappings":"AA8BA;EACE,aAAA;EACA,mBAAA;EACA,qBAAA;EACA,cAAA;AA7BF","file":"ChatMessage.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.message-wrap {\n  display: flex;\n  flex-direction: row;\n  align-items: flex-end;\n  max-width: 90%;\n}\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".conversation--container[data-v-7b314d1e] {\n  display: flex;\n  flex-direction: column;\n  flex: 1 1;\n  overflow-y: auto;\n}\n.conversation-wrap[data-v-7b314d1e] {\n  flex: 1 1;\n  padding: 2rem 0.5rem 0.5rem 0.5rem;\n}\n.message--loader[data-v-7b314d1e] {\n  text-align: center;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/ConversationWrap.vue"],"names":[],"mappings":"AA0GA;EACE,aAAA;EACA,sBAAA;EACA,SAAA;EACA,gBAAA;AAzGF;AA4GA;EACE,SAAA;EACA,kCAAA;AAzGF;AA4GA;EACE,kBAAA;AAzGF","file":"ConversationWrap.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n@import '~widget/assets/scss/mixins.scss';\n\n.conversation--container {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  overflow-y: auto;\n}\n\n.conversation-wrap {\n  flex: 1;\n  padding: $space-large $space-small $space-small $space-small;\n}\n\n.message--loader {\n  text-align: center;\n}\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".file .icon-wrap[data-v-323246ac] {\n  font-size: 2.5rem;\n  color: #1f93ff;\n  line-height: 1;\n  margin-left: 0.25rem;\n  margin-right: 0.5rem;\n}\n.file .title[data-v-323246ac] {\n  font-weight: 500;\n  font-size: 0.875rem;\n  margin: 0;\n}\n.file .download[data-v-323246ac] {\n  color: #1f93ff;\n  font-weight: 500;\n  padding: 0;\n  margin: 0;\n  font-size: 0.75rem;\n  text-decoration: none;\n}\n.file .link-wrap[data-v-323246ac] {\n  line-height: 1;\n}\n.file .meta[data-v-323246ac] {\n  padding-right: 0.25rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/FileBubble.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAoEE;EACE,iBC5Da;ED6Db,cCjCS;EDkCT,cAAA;EACA,oBCzDY;ED0DZ,oBCzDU;ADVd;AAsEE;EACE,gBC7CiB;ED8CjB,mBC1EgB;ED2EhB,SAAA;AApEJ;AAuEE;EACE,cC9CS;ED+CT,gBCpDiB;EDqDjB,UAAA;EACA,SAAA;EACA,kBCpFc;EDqFd,qBAAA;AArEJ;AAwEE;EACE,cAAA;AAtEJ;AAwEE;EACE,sBChFY;ADUhB","file":"FileBubble.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.file {\n  .icon-wrap {\n    font-size: $font-size-mega;\n    color: $color-woot;\n    line-height: 1;\n    margin-left: $space-smaller;\n    margin-right: $space-small;\n  }\n\n  .title {\n    font-weight: $font-weight-medium;\n    font-size: $font-size-default;\n    margin: 0;\n  }\n\n  .download {\n    color: $color-woot;\n    font-weight: $font-weight-medium;\n    padding: 0;\n    margin: 0;\n    font-size: $font-size-small;\n    text-decoration: none;\n  }\n\n  .link-wrap {\n    line-height: 1;\n  }\n  .meta {\n    padding-right: $space-smaller;\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".image[data-v-28730f73] {\n  display: block;\n}\n.image .wrap[data-v-28730f73] {\n  position: relative;\n  display: flex;\n  max-width: 100%;\n}\n.image .wrap[data-v-28730f73]::before {\n  background-image: linear-gradient(-180deg, transparent 3%, #1f2d3d 130%);\n  bottom: 0;\n  content: \"\";\n  height: 20%;\n  left: 0;\n  opacity: 0.8;\n  position: absolute;\n  width: 100%;\n}\n.image img[data-v-28730f73] {\n  width: 100%;\n  max-width: 250px;\n}\n.image .time[data-v-28730f73] {\n  font-size: 0.75rem;\n  bottom: 0.25rem;\n  color: #fff;\n  position: absolute;\n  right: 0.75rem;\n  white-space: nowrap;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/ImageBubble.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAoCA;EACE,cAAA;AAnCF;AAqCE;EACE,kBAAA;EACA,aAAA;EACA,eAAA;AAnCJ;AAqCI;EACE,wEAAA;EAKA,SAAA;EACA,WAAA;EACA,WAAA;EACA,OAAA;EACA,YAAA;EACA,kBAAA;EACA,WAAA;AAvCN;AA2CE;EACE,WAAA;EACA,gBAAA;AAzCJ;AA4CE;EACE,kBC/Dc;EDgEd,eCpDY;EDqDZ,WCrBU;EDsBV,kBAAA;EACA,cCpDS;EDqDT,mBAAA;AA1CJ","file":"ImageBubble.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.image {\n  display: block;\n\n  .wrap {\n    position: relative;\n    display: flex;\n    max-width: 100%;\n\n    &::before {\n      background-image: linear-gradient(\n        -180deg,\n        transparent 3%,\n        $color-heading 130%\n      );\n      bottom: 0;\n      content: '';\n      height: 20%;\n      left: 0;\n      opacity: 0.8;\n      position: absolute;\n      width: 100%;\n    }\n  }\n\n  img {\n    width: 100%;\n    max-width: 250px;\n  }\n\n  .time {\n    font-size: $font-size-small;\n    bottom: $space-smaller;\n    color: $color-white;\n    position: absolute;\n    right: $space-slab;\n    white-space: nowrap;\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".chat-bubble.user[data-v-1e0ac394] pre {\n  background: #c7e3ff;\n  color: #3c4858;\n  overflow: scroll;\n  padding: 0.25rem;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/UserMessageBubble.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAkCA;EACE,mBCoBoB;EDnBpB,cCYW;EDXX,gBAAA;EACA,gBCvBc;ADVhB","file":"UserMessageBubble.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.chat-bubble.user::v-deep pre {\n  background: $color-primary-light;\n  color: $color-body;\n  overflow: scroll;\n  padding: $space-smaller;\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".article-item[data-v-7cdcc825] {\n  border-bottom: 1px solid #e0e6ed;\n  font-size: 0.875rem;\n  padding: 0.5rem 0;\n}\n.article-item a[data-v-7cdcc825] {\n  color: #3c4858;\n  text-decoration: none;\n}\n.article-item .description[data-v-7cdcc825] {\n  display: block;\n  margin-top: 0.25rem;\n}\n.article-item[data-v-7cdcc825]:last-child {\n  border-bottom: 0;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/template/Article.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAqCA;EACE,gCAAA;EACA,mBCnCkB;EDoClB,iBAAA;AApCF;AAsCE;EACE,cCKS;EDJT,qBAAA;AApCJ;AAuCE;EACE,cAAA;EACA,mBClCY;ADHhB;AAwCE;EACE,gBAAA;AAtCJ","file":"Article.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.article-item {\n  border-bottom: 1px solid $color-border;\n  font-size: $font-size-default;\n  padding: $space-small 0;\n\n  a {\n    color: $color-body;\n    text-decoration: none;\n  }\n\n  .description {\n    display: block;\n    margin-top: $space-smaller;\n  }\n\n  &:last-child {\n    border-bottom: 0;\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".email-input-group[data-v-46fd4a2f] {\n  display: flex;\n  margin: 0.5rem 0;\n  min-width: 200px;\n}\n.email-input-group input[data-v-46fd4a2f] {\n  border-bottom-right-radius: 0;\n  border-top-right-radius: 0;\n  padding: 0.625rem;\n  width: 100%;\n}\n.email-input-group input.error[data-v-46fd4a2f] {\n  border-color: #ff382d;\n}\n.email-input-group .button[data-v-46fd4a2f] {\n  border-bottom-left-radius: 0;\n  border-top-left-radius: 0;\n  font-size: 1.25rem;\n  height: auto;\n  margin-left: -1px;\n}\n.email-input-group .button .spinner[data-v-46fd4a2f] {\n  display: block;\n  padding: 0;\n  height: auto;\n  width: auto;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/template/EmailInput.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AAgGA;EACE,aAAA;EACA,gBAAA;EACA,gBAAA;AA/FF;AAiGE;EACE,6BAAA;EACA,0BAAA;EACA,iBCvFQ;EDwFR,WAAA;AA/FJ;AAiGI;EACE,qBC1DQ;ADrCd;AAmGE;EACE,4BAAA;EACA,yBAAA;EACA,kBC7Gc;ED8Gd,YAAA;EACA,iBAAA;AAjGJ;AAmGI;EACE,cAAA;EACA,UAAA;EACA,YAAA;EACA,WAAA;AAjGN","file":"EmailInput.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables.scss';\n\n.email-input-group {\n  display: flex;\n  margin: $space-small 0;\n  min-width: 200px;\n\n  input {\n    border-bottom-right-radius: 0;\n    border-top-right-radius: 0;\n    padding: $space-one;\n    width: 100%;\n\n    &.error {\n      border-color: $color-error;\n    }\n  }\n\n  .button {\n    border-bottom-left-radius: 0;\n    border-top-left-radius: 0;\n    font-size: $font-size-large;\n    height: auto;\n    margin-left: -1px;\n\n    .spinner {\n      display: block;\n      padding: 0;\n      height: auto;\n      width: auto;\n    }\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "card-message chat-bubble agent" }, [
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "form chat-bubble agent" }, [
    _c(
      "form",
      {
        on: {
                ...
                ? _c("input", {
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.$set(_vm.formValues, item.name, $event.target.value)
                      }
                    }
                  })
                : item.type === "text"
          ...
          ? _c(
              ...
              [
                _vm._v(
                  "\n      " +
                    _vm._s(
                      _vm.buttonLabel || _vm.$t("COMPONENTS.FORM_BUBBLE.SUBMIT")
                    ) +
                    "\n    "
                )
              ]
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "options-message chat-bubble agent" }, [
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "customer-satisfcation",
      style: { borderColor: _vm.widgetColor }
    },
    [
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "date--separator" }, [
        ...
        ? _c(
            ...
            [
              _c("div", {
                ...
                domProps: {
                  innerHTML: _vm._s(_vm.formatMessage(_vm.message, false))
                }
              }),
              _vm._v(" "),
              _vm.isTemplateEmail
    ...
    return _c("div", { staticClass: "agent-message-wrap" }, [
      _c("div", { staticClass: "agent-message" }, [
        ...
        _c("div", { staticClass: "message-wrap" }, [
          _c("div", { staticClass: "typing-bubble chat-bubble agent" }, [
            _c("img", {
              attrs: {
...
var render = function() {
  ...
  return _c(
    "file-upload",
    {
      ...
      on: { "input-file": _vm.onDirectFileUpload }
    },
    [
      _c(
        "button",
...
var render = function() {
  ...
  return !_vm.hideReplyBox
    ? _c(
        "footer",
        { staticClass: "shadow-sm rounded-lg bg-white mb-1 z-50 relative" },
        [
          _c("chat-input-wrap", {
            attrs: {
  ...
  return _c(
    ...
    [
      _c("resizable-text-area", {
        ref: "chatInput",
        staticClass: "form-input user-message-input",
        attrs: {
          id: "chat-input",
        ...
        [
          ...
          _vm.hasEmojiPickerEnabled
            ? _c(
                ...
                [
                  _c("fluent-icon", {
                    class: { "text-woot-500": _vm.showEmojiPicker },
                    attrs: { icon: "emoji" }
                  })
                ],
                1
...
var render = function() {
  ...
  return _c("div", {
    ...
    domProps: { innerHTML: _vm._s(_vm.formatMessage(_vm.message, false)) }
  })
}
var staticRenderFns = []
render._withStripped = true
...
//# sourceMappingURL=4-43afaf7fe8e60ecef879.chunk.js.map