...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [shared_mixins_messageFormatterMixin__WEBPACK_IMPORTED_MODULE_3__["default"], _mixins_configMixin__WEBPACK_IMPORTED_MODULE_5__["default"]],
  props: {
    message: {
      type: String,
      "default": ''
...
/* harmony import */ var widget_helpers_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! widget/helpers/utils */ "./app/javascript/widget/helpers/utils.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.js");
...
/* harmony import */ var _mixins_configMixin__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../mixins/configMixin */ "./app/javascript/widget/mixins/configMixin.js");
/* harmony import */ var _constants_widgetBusEvents__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../constants/widgetBusEvents */ "./app/javascript/widget/constants/widgetBusEvents.js");
/* harmony import */ var shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! shared/components/FluentIcon/Index.vue */ "./app/javascript/shared/components/FluentIcon/Index.vue");
/* harmony import */ var widget_components_UnreadMessage_vue__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! widget/components/UnreadMessage.vue */ "./app/javascript/widget/components/UnreadMessage.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Unread',
  components: {
    FluentIcon: shared_components_FluentIcon_Index_vue__WEBPACK_IMPORTED_MODULE_23__["default"],
    UnreadMessage: widget_components_UnreadMessage_vue__WEBPACK_IMPORTED_MODULE_24__["default"]
  },
  mixins: [_mixins_configMixin__WEBPACK_IMPORTED_MODULE_21__["default"]],
  props: {
    messages: {
      type: Array,
      required: true
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_20__["mapGetters"])({
  ...
  methods: {
    openConversationView: function openConversationView() {
      bus.$emit(_constants_widgetBusEvents__WEBPACK_IMPORTED_MODULE_22__["ON_UNREAD_MESSAGE_CLICK"]);
    },
    closeFullView: function closeFullView() {
      if (widget_helpers_utils__WEBPACK_IMPORTED_MODULE_19__["IFrameHelper"].isIFrame()) {
        widget_helpers_utils__WEBPACK_IMPORTED_MODULE_19__["IFrameHelper"].sendMessage({
          event: 'toggleBubble'
        });
      }
    },
...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, ".unread-wrap[data-v-3325a142] {\n  width: 100%;\n  height: auto;\n  max-height: 100vh;\n  background: transparent;\n  display: flex;\n  flex-direction: column;\n  flex-wrap: nowrap;\n  justify-content: flex-end;\n  overflow: hidden;\n}\n.unread-wrap .unread-messages[data-v-3325a142] {\n  padding-bottom: 0.5rem;\n}\n.unread-wrap .clear-button[data-v-3325a142] {\n  background: transparent;\n  color: #1f93ff;\n  padding: 0;\n  border: 0;\n  font-weight: 600;\n  font-size: 1rem;\n  transition: all 0.3s cubic-bezier(0.17, 0.67, 0.83, 0.67);\n  margin-left: 0.25rem;\n  padding-right: 0.625rem;\n}\n.unread-wrap .clear-button[data-v-3325a142]:hover {\n  transform: translateX(0.25rem);\n  color: #005fb8;\n}\n.unread-wrap .close-unread-button[data-v-3325a142] {\n  background: #f4f6fb;\n  color: #999a9b;\n  border: 0;\n  font-weight: 500;\n  font-size: 0.625rem;\n  transition: all 0.3s cubic-bezier(0.17, 0.67, 0.83, 0.67);\n  margin-bottom: 0.75rem;\n  border-radius: 1rem;\n}\n.unread-wrap .close-unread-button[data-v-3325a142]:hover {\n  color: #3c4858;\n}", "",{"version":3,"sources":["/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/components/UnreadMessageList.vue","/Users/pritivirajkumar/Documents/GitHub/Bonsai_EndGame/app/javascript/widget/assets/scss/_variables.scss"],"names":[],"mappings":"AA2FA;EACE,WAAA;EACA,YAAA;EACA,iBAAA;EACA,uBAAA;EACA,aAAA;EACA,sBAAA;EACA,iBAAA;EACA,yBAAA;EACA,gBAAA;AA1FF;AA4FE;EACE,sBCvFU;ADHd;AA6FE;EACE,uBAAA;EACA,cCvES;EDwET,UAAA;EACA,SAAA;EACA,gBC9Ee;ED+Ef,eC3Ge;ED4Gf,yDAAA;EACA,oBCnGY;EDoGZ,uBClGQ;ADOZ;AA6FI;EACE,8BAAA;EACA,cC/De;AD5BrB;AA+FE;EACE,mBC/Ee;EDgFf,cCrFe;EDsFf,SAAA;EACA,gBC/FiB;EDgGjB,mBC9Ha;ED+Hb,yDAAA;EACA,sBChHS;EDiHT,mBChHW;ADmBf;AA+FI;EACE,cCtFO;ADPb","file":"UnreadMessageList.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n@import '~widget/assets/scss/variables';\n\n.unread-wrap {\n  width: 100%;\n  height: auto;\n  max-height: 100vh;\n  background: transparent;\n  display: flex;\n  flex-direction: column;\n  flex-wrap: nowrap;\n  justify-content: flex-end;\n  overflow: hidden;\n\n  .unread-messages {\n    padding-bottom: $space-small;\n  }\n\n  .clear-button {\n    background: transparent;\n    color: $color-woot;\n    padding: 0;\n    border: 0;\n    font-weight: $font-weight-bold;\n    font-size: $font-size-medium;\n    transition: all 0.3s $ease-in-cubic;\n    margin-left: $space-smaller;\n    padding-right: $space-one;\n\n    &:hover {\n      transform: translateX($space-smaller);\n      color: $color-primary-dark;\n    }\n  }\n\n  .close-unread-button {\n    background: $color-background;\n    color: $color-light-gray;\n    border: 0;\n    font-weight: $font-weight-medium;\n    font-size: $font-size-mini;\n    transition: all 0.3s $ease-in-cubic;\n    margin-bottom: $space-slab;\n    border-radius: $space-normal;\n\n    &:hover {\n      color: $color-body;\n    }\n  }\n}\n","// Font sizes\n$font-size-micro: 0.5rem;\n$font-size-mini: 0.625rem;\n$font-size-small: 0.75rem;\n$font-size-default: 0.875rem;\n$font-size-medium: 1rem;\n$font-size-large: 1.25rem;\n$font-size-big: 1.5rem;\n$font-size-bigger: 2rem;\n$font-size-mega: 2.5rem;\n$font-size-giga: 3.5rem;\n\n// spaces\n$zero: 0;\n$space-micro: 0.125rem;\n$space-smaller: 0.25rem;\n$space-small: 0.5rem;\n$space-one: 0.625rem;\n$space-slab: 0.75rem;\n$space-normal: 1rem;\n$space-two: 1.25rem;\n$space-medium: 1.5rem;\n$space-large: 2rem;\n$space-larger: 3rem;\n$space-big: 4rem;\n$space-jumbo: 5rem;\n$space-mega: 6.25rem;\n\n// font-weight\n$font-weight-feather: 100;\n$font-weight-light: 300;\n$font-weight-normal: 400;\n$font-weight-medium: 500;\n$font-weight-bold: 600;\n$font-weight-black: 700;\n\n// Colors\n$color-woot: #1f93ff;\n$color-primary: $color-woot;\n$color-gray: #6e6f73;\n$color-light-gray: #999a9b;\n$color-border: #e0e6ed;\n$color-border-transparent: rgba(224, 230, 237, 0.5);\n$color-border-light: #f0f4f5;\n$color-border-dark: #cad0d4;\n$color-background: #f4f6fb;\n$color-background-light: #fafafa;\n$color-white: #fff;\n$color-body: #3c4858;\n$color-heading: #1f2d3d;\n$color-error: #ff382d;\n$color-success: #44ce4b;\n\n// Color-palettes\n\n$color-primary-light: #c7e3ff;\n$color-primary-dark: darken($color-woot, 20%);\n\n// Spinner\n$spinkit-spinner-color: $color-white !default;\n$spinkit-spinner-margin: 0 0 0 1.6rem !default;\n$spinkit-size: 1.6rem !default;\n\n// Snackbar default\n$woot-snackbar-bg: #323232;\n$woot-snackbar-button: #ffeb3b;\n\n$swift-ease-out-duration: .4s !default;\n$swift-ease-out-timing-function: cubic-bezier(.25, .8, .25, 1) !default;\n$swift-ease-out: all $swift-ease-out-duration $swift-ease-out-timing-function !default;\n\n$border-radius: 0.1875px;\n$line-height: 1;\n$footer-height: 11.2rem;\n$header-expanded-height: $space-medium * 10;\n\n$font-family: 'Inter',\n-apple-system,\nsystem-ui,\nBlinkMacSystemFont,\n\"Segoe UI\",\nRoboto,\n\"Helvetica Neue\",\nTahoma,\nArial,\nsans-serif;\n\n// Break points\n$break-point-medium: 667px;\n\n// Timing functions\n\n$ease-in-cubic: cubic-bezier(.17, .67, .83, .67);\n"]}]);
// Exports
module.exports = exports;
...
var render = function() {
  ...
  return _c("div", { staticClass: "chat-bubble-wrap" }, [
    _c(
      "button",
      { staticClass: "chat-bubble agent", on: { click: _vm.onClickMessage } },
      [
        _vm.showSender
          ? _c(
              "div",
...
//# sourceMappingURL=3-390697cf4c29b63816ac.chunk.js.map